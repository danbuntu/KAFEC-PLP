...
//$_SESSION['toolkits_firstname'] = Dan;//moodle session firstname
//
//$_SESSION['toolkits_surname'] = Attwood;//moodle session lastname
//
//$_SESSION['toolkits_logon_username'] = dattwood;//moodle session username

echo $_SESSION['toolkits_firstname'];
echo $_SESSION['toolkits_surname'] = Attwood;//moodle session lastname

echo $_SESSION['toolkits_logon_username'] = dattwood;//m

/*This is the toolkits config file
*/
	require("config.php");
	...
	*/
	...
	if(check_if_first_time($_SESSION['toolkits_logon_username'])){
		...
		*/
        ...
        echo 'id after login:' . $_SESSION['toolkits_logon_id'];
	recycle_bin();
