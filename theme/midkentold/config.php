...
$arrowright = '<img src="' . $CFG->wwwroot .'/theme/midkent/pix/r_breadcrumb.gif' . '">';
$arrowleft = '<img src="' . $CFG->wwwroot .'/theme/midkent/pix/l_breadcrumb.gif' . '">';
$THEME->rarrow		 = $arrowright;
$THEME->larrow		 = $arrowleft;
?>
