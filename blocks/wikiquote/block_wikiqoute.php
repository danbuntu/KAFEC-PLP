...
define('MAGPIE_CACHE_DIR', $CFG->dirroot . '/blocks/wikiqoute/cache');
...
class block_wikiqoute extends block_base {
  function init() {
    $this->title   = get_string('title', 'block_word');
...
// uppercase the first letter
 	...
 	$this->content->text  .= '<div= worddesc>' . $description . '</div>';
        $this->content->text  .= '<div style="text-align: center;"><a rel="friend " target="_blank" href="' . $link . '">More Information</a>';
        $this->content->text  .= '<div style="text-align: center;"><small><small><a rel="friend " target="_blank" href="http://en.wikiqoute.org">Powered by Wikiqoute.org</a></small></small></div></div>';
