...
(function($) {
	$.extend({
		tablesorterFilter: new function() {
            ...
            /**
             * Method to check whether a given cell's text contains
            ...
            /**
             * Method runs filtering across a table using the
             * phrase given
             */
			function doFilter(table, phrase) {
				if(table.config.debug) { var cacheTime = new Date(); }

				var phrase_length = phrase.length; // The length of the phrase being searched for
				var caseSensitive = table.config.filterCaseSensitive;  // Whether or not the filter is set for case
