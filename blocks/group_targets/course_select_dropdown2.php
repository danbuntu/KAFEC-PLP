                    ...
                    <tr>
                        <td>
                            <form name="process" action="<?PHP echo $_SERVER['PHP_SELF'] ?>" method="POST">
                                ...
                                <input class="btn info" type="submit" name="filter" value="filter"/>
                            </form>
                        </td>
...
//filter by groups
                            ...
                            if ($num_rows == 0) {
                                ...
                                echo '<input class="btn info" type="submit" name="filter" value="filter" />';
                                echo '</form>';

                                // get the group name
                                $queryGroupName = "SELECT name FROM mdl_groups WHERE id='" . $_SESSION['course_group_session'] . "'";
                                //echo $queryGroupName;
