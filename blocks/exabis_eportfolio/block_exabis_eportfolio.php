...
class block_exabis_eportfolio extends block_list {
    ...
    function get_content() {
		...
		$this->content->items[]='<a title="' . get_string('sharedbookmarks', 'block_exabis_eportfolio') . '" href="' . $CFG->wwwroot . '/blocks/exabis_eportfolio/viewpeople.php?courseid=' . $COURSE->id . '">' . get_string('sharedbookmarks', 'block_exabis_eportfolio') . '</a>';
		...
		$this->content->items[]='<a title="' . get_string('export', 'block_exabis_eportfolio') . '" href="' . $CFG->wwwroot . '/blocks/exabis_eportfolio/export.php?courseid=' . $COURSE->id . '">' . get_string('export', 'block_exabis_eportfolio') . '</a>';
