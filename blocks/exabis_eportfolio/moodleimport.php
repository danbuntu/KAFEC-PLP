...
<?php
	...
	$strimport = get_string("moodleimport","block_exabis_eportfolio");
		...
		foreach ($assignments as $assignment) {
			...
			if ($files = get_directory_list($CFG->dataroot . '/' . $basedir)) {
                ...
                foreach ($files as $key => $file) {
                    ...
                    $icons .= '<a href="' . $CFG->wwwroot . '/blocks/exabis_eportfolio/add_file_from_moodleimport.php?courseid=' . $courseid . '&amp;assignmentid=' . $assignment->id . '&amp;filename=' . $file . '&amp;sesskey=' . sesskey() . '">' .
