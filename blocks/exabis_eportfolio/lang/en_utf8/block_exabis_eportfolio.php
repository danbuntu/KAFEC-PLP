...
$string['explainingexternal'] = "External Links.  These links may be shared with all authorized course members.";
...
$string['newexternal'] = "Add new external link";
$string['newfile'] = "Add new file";
$string['newnote'] = "Add new note";
$string['nocategories'] = "(no categories yet)";
$string['nobookmarks'] = "(no bookmarks yet)";
$string['nobookmarksexternal'] = "(no external links yet)";
...
$string['bookmarksexternal'] = "External links";
...
$string['deleteextconfirm'] = "Do you really want to delete this link?";
