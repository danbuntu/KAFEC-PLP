...
if (isset($_POST['update'])) {
    ...
    $query = 'UPDATE apprentice_effectiveness SET name="' . $_POST['effectiveness'] . '" WHERE id="' . $_POST['id'] . '"';
    echo $query . '</br>';
    mysql_query($query);
}

if (isset($_POST['submit_add_new'])) {
    $query = "INSERT INTO apprentice_effectiveness (name) VALUES ('" . $_POST['new'] . "')";
    echo $query;
    mysql_query($query);
}

if (isset($_POST['delete'])) {
    $query = "DELETE FROM apprentice_effectiveness WHERE id='" . $_POST['id'] . "'";
    echo $query;
    mysql_query($query);
}
...
if (isset($_POST['deleteEmployer'])) {
    $query = "DELETE FROM apprentice_employers WHERE id='" . $_POST['employerId'] . "'";
    echo $query;
    mysql_query($query);
}
...
if (isset($_POST['deleteCourse'])) {
    $query = "DELETE FROM apprentice_courses WHERE id='" . $_POST['courseId'] . "'";
    echo $query;
    mysql_query($query);
}
...
if (isset($_POST['newEmployer'])) {
    $query = "INSERT INTO apprentice_employers (name) VALUES ('" . $_POST['newEmployer'] . "')";
    echo $query;
    mysql_query($query);
...
if (isset($_POST['updateEmployer'])) {
    ...
    $query = 'UPDATE apprentice_employers SET name="' . $_POST['employerName'] . '" WHERE id="' . $_POST['employer_id'] . '"';
    echo $query . '</br>';
    mysql_query($query);
}
...
if (isset($_POST['updateCourse'])) {
    $query = "UPDATE apprentice_courses SET coursename='" . $_POST['courseName'] . "', course_code='" . $_POST['courseId'] . "' WHERE  id='" . $_POST['id'] . "' ";
    echo $query;
    mysql_query($query);
}
...
if (isset($_POST['submit_new_Course'])) {
    $query = "INSERT INTO apprentice_courses (course_code, coursename) VALUES ('" . $_POST['courseid'] . "','" . $_POST['coursename'] . "')";
    echo $query;
    mysql_query($query);
}
...
$query = "select * from apprentice_employers";
$result = mysql_query($query);
...
$query = "SELECT c.id, c.course_code, c.coursename, c.employerid, e.id as id2, e.name, e.logo FROM apprentice_courses c LEFT JOIN apprentice_employers e ON c.employerid=e.id";
$result = mysql_query($query);
