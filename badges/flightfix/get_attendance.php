...
//echo 'Total present days ' . $present . '<br/>';
//echo 'Total possible days ' . $possible . '<br/>';
//echo 'Total absent days ' . $absent . '<br/>';

//echo 'Present is : ' . $presentdays . '<br/>';
//echo 'Possible is: ' . $possible . '<br/>';

 //echo 'Present: ' . $present . '<br/>';
//echo 'Possible: ' . $possible . '<br/>';
//echo 'Absent: ' . $absent . '<br/>';
$totalattendance = $presentdays/$possible;
//echo 'total is: ' . $totalattendance . '<br/>';
...
//echo 'Total attendance ' . $totalattendance . '<br/>';
