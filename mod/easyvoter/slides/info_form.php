...
//SCRIPT: slides/info_form.php
//VERSION: 2010060700
//MODULE: easyvoter
//NOTES: Form for information slide
////////////////////////////////////////////////////////////////////////////
...
class info_form extends moodleform {
    ...
    function definition() {
		...
		$mform =& $this->_form;
		if($sid>0){
			$mform->addElement('header', 'addedit', get_string('easyvoterinfotype', 'easyvoter').' ('.get_string('easyvoteredit', 'easyvoter').')');
		}else{
			$mform->addElement('header', 'addedit', get_string('easyvoterinfotype', 'easyvoter').' ('.get_string('easyvoteradd', 'easyvoter').')');
		}
	...
	//HIDDEN FIELDS
		...
		$mform->addElement('hidden', 'type', 'info');
		if($sid>0){
