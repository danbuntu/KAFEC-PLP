...
class resource_mrcuteput extends resource_base
{
	...
	function setup_elements(&$mform)
	{
		...
		$url = "/mod/resource/type/mrcuteput/uploader.php";
        $options = 'menubar=0,location=0,scrollbars,resizable,width=700,height=600';
		$fullscreen = 0;
		$buttonattributes = array("onclick"=>"return openpopup('$url', 'uploader', '$options', $fullscreen);");
		$mform->addElement('button', 'new',			get_string('newpackage', 'resource_mrcuteput'), $buttonattributes);
		
		$url = "/mod/resource/type/mrcuteput/uploadimszip.php";
        $options = 'menubar=0,location=0,scrollbars,resizable,width=700,height=450';
		$fullscreen = 0;
		$buttonattributes = array("onclick"=>"return openpopup('$url', 'uploadimszip', '$options', $fullscreen);");
		$mform->addElement('button', 'existing',	get_string('existingpackage', 'resource_mrcuteput'), $buttonattributes );
