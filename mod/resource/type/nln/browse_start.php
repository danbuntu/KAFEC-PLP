...
echo '<p style="padding:20px; font-family: Verdana, Arial"><img align="absmiddle" src="busy.gif" /> Connecting to the NLN Materials browser...</p><form id="noodStart" action="http://www.nln.ac.uk/noodle.asp?act=Start" method="post">';
echo '<input type="hidden" name="orgId" value="'.$CFG->orgID.'" />';
echo '<input type="hidden" name="orgPass" value="'.$CFG->orgPass.'" />';
