<?php // $Id: resource.class.php,v 1.1 2008/04/08 00:05:21 arborrow Exp $

require_once('nln_config.php');
...
//error("res: ".$resource->reference);
    ...
    function setup_elements(&$mform)
        {
// TODO: the following JS needs to be attatched to the page somewhere, to remove the onblur even handler from the title input element.
// Without overriding this handler, the user is dragged back to the title box, even though the NLN browser will fill this in automatically
// var i=document.getElementById("id_name");if(i) i.onblur=null;
